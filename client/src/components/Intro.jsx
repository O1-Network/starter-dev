    ...
    return (
        <div className="intro" >
          <div className="intro-statement">
            {/* <img className="intro-image" src="https://placeimg.com/640/480/tech" alt="image placeholder"></img> */}
            <div className="container">
            <div className="row1">
            <div className="intro-text"> <p>If you're business is selected, our team of developers will build you a digital tool that takes your business to the next level.</p></div>
             <div className="empty">
                              </div>
             </div>
